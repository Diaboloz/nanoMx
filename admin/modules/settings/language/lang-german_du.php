...
define("_ADMIN_FOOTCONSTMSG", "Du kannst auch die in den Sprachdateien definierten Konstanten _Z1 bis _Z4 als Feldwerte verwenden:<br /><br /><b>_Z1= <br /></b>" . _Z1 . "<br /><b>_Z2= <br /></b>" . _Z2 . "<br /><b>_Z3= </b><br />" . _Z3 . "<br /><b>_Z4= </b><br />" . _Z4 . "");
define("_ADMIN_LASTCHANGE", "letzte Änderung am");
define("_ADMIN_NOREFS", "Um diese Funktion zu deaktiveren, '<b>0</b>' auswählen.");
...
define("_ANONYMOUSNAME", "Alias für unangemeldete Benutzer");
...
define("_LOGGINWARNING", "Nach dem ändern dieser Option musst Du Dich evtl. neu einloggen.");
...
define("_SECDAYS2", "Bei <b>0</b> müssen sich die Benutzer bei jedem Browserstart neu anmelden.");
...
define("_SECSQLINJECT3", "Weitere Einstellmöglichkeiten hierzu, findest Du in der Datei <i>includes/detection/config.php</i>.");
