...
class pmx_editor_wymeditor {
    ...
    /**
     * pmx_editor_wymeditor::__construct()
    ...
    public function getHtml()
    {
         ...
         */
        pmxHeader::add_jquery('ui/jquery.ui.draggable.js',
            'ui/jquery.ui.resizable.js',
            'ui/jquery.ui.sortable.js'
            );

        pmxHeader::add_script($this->editor_path . 'jquery.wymeditor.min.js');
        // pmxHeader::add_script($this->editor_path . 'js/i18n/wymeditor.' . $this->lang . '.js');
        // pmxHeader::add_style($this->editor_path . 'css/wymeditor.min.css');
        // pmxHeader::add_style($this->editor_path . 'css/smoothness/jquery-ui-1.8.13.custom.css');
        // pmxHeader::add_style($this->editor_path . '../../../filemanager/elfinder/css/elfinder.css');
        // pmxHeader::add_script($this->editor_path . '../../../filemanager/elfinder/js/elfinder.min.js');
        // pmxHeader::add_script($this->editor_path . '../../../filemanager/elfinder/js/i18n/elfinder.' . $this->lang . '.js');
    ...
    protected function set_dimensions()
    {
        ...
        mxDebugFuncVars($this->width, $this->height);
    }
}
