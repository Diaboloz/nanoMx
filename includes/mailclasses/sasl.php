 ...
 * sasl.php
 *
 * @(#) $Id: sasl.php 6 2015-07-08 07:07:06Z PragmaMx $
...
<class>
	...
	<version>@(#) $Id: sasl.php 6 2015-07-08 07:07:06Z PragmaMx $</version>
...
*/
    ...
    var $driver;
    var $drivers = array("Digest" => array("digest_sasl_client_class", "digest_sasl_client.php"),
...
// changes for pragmaMx
                if (!class_exists($this->drivers[$mechanism][0], false))
                    require(dirname(__FILE__) . '/sasl_clients/' . $this->drivers[$mechanism][1]); //geändert, damit sasl-clients in eigenem Verzeichnis liegen
