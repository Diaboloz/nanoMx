 ...
 *
 * @(#) $Id: ntlm_sasl_client.php 6 2015-07-08 07:07:06Z PragmaMx $
...
class ntlm_sasl_client_class {
    ...
    Function Initialize(&$client)
    {
        if (!function_exists($function = "mcrypt_encrypt") || !function_exists($function = "mhash")) {
            $extensions = array("mcrypt_encrypt" => "mcrypt",
                "mhash" => "mhash"
                );
    ...
    Function TypeMsg3($ntlm_response, $user, $domain, $workstation)
    {
        ...
        return("NTLMSSP\0" . "\x03\x00\x00\x00" .
            pack("v", $lm_length) .
            pack("v", $lm_length) .
            pack("V", $lm_offset) .
            pack("v", $ntlm_length) .
