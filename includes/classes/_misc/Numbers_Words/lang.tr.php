 ...
 * @version CVS: $Id: lang.tr.php 6 2015-07-08 07:07:06Z PragmaMx $
 ...
 *
 * @author Piotr Klaban
 * @author Sitki Özkurt (for Turkish Translations)
 * @package Numbers_Words
 */
 ...
 * @link http://pear.php.net/package/Numbers_Words
 */
class Numbers_Words_tr extends Numbers_Words {
    // {{{ properties
    /**
     * Locale name
     *
    ...
    var $_exponent = array(0 => array(''),
        ...
        66 => array('andesilyon'),
        72 => array('dodesilyon'),
        78 => array('tredesilyon'),
        84 => array('katordesilyon'),
        90 => array('kendesilyon'),
        96 => array('seksdesilyon'),
        102 => array('septendesilyon'),
        108 => array('oktodesilyon'),
        114 => array('novemdesilyon'),
        120 => array('vigintilyon'),
        600 => array('sentilyon')
        );
     ...
     * @access private
     */
    var $_digits = array(0 => 'sýfýr', 'bir', 'iki', 'üç', 'dört',
