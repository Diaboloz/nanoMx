 ...
 * @version $Id: Savant3_Plugin_form.php 6 2015-07-08 07:07:06Z PragmaMx $
 */
...
class Savant3_Plugin_form extends Savant3_Plugin {
    ...
    protected $_base = array('name' => null,
        'type' => null,
        'label' => null,
        'descr' => null,
        'value' => null,
    ...
    /* Alias for begin() */
    protected function open($attribs = null)
    {
     ...
     *
     * @access protected
     * @return string The ending </form> tag.
     */
                ...
                if (! $this->_inGroup) {
                    ...
                    if ($this->_blockType == 'col') {
                        ...
                        if (! is_null($label)) {
                            ...
                            $xhtml .= htmlspecialchars($label, ENT_COMPAT | ENT_HTML5, 'UTF-8', false);
                            $xhtml .= '</label>';
                        }
        ...
        $clear = null)
    {
        ...
        if (is_string($this->_blockLabel)) {
            ...
            if (! empty($this->_blockLabel)) {
                ...
                $xhtml .= htmlspecialchars($this->_blockLabel, ENT_COMPAT | ENT_HTML5, 'UTF-8', false);
                $xhtml .= '</legend>';
            }
        } else {
        ...
        $xhtml .= $this->_tag('table', array('class' => 'form ' . $type . ''));
