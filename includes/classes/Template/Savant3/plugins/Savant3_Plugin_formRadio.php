 ...
 * @version $Id: Savant3_Plugin_formRadio.php 6 2015-07-08 07:07:06Z PragmaMx $
 */
        ...
        $options = null, $listsep = "<br />\n")
    {
        ...
        if ($disable) {
            ...
            foreach ($options as $opt_value => $opt_label) {
                ...
                $radio .= ' name="' . htmlspecialchars($name, ENT_COMPAT | ENT_HTML5, 'UTF-8', false) . '"';
                $radio .= ' value="' . htmlspecialchars($opt_value, ENT_COMPAT | ENT_HTML5, 'UTF-8', false) . '"';
                // is it checked?
                if ($opt_value == $value) {
                ...
                $radio .= htmlspecialchars($opt_label, ENT_COMPAT | ENT_HTML5, 'UTF-8', false) . '</label>';
