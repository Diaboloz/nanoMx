 ...
 * @version $Id: Savant3_Plugin_ahref.php 6 2015-07-08 07:07:06Z PragmaMx $
 */
...
class Savant3_Plugin_ahref extends Savant3_Plugin {
    ...
    public function ahref($href, $text, $attr = null)
    {
        ...
        if (is_array($href)) {
            ...
            $html .= htmlspecialchars($tmp, ENT_COMPAT | ENT_HTML5, 'UTF-8', false);
        } else {
            // add the HREF from a scalar
            $html .= htmlspecialchars(str_replace('&amp;', '&', $href), ENT_COMPAT | ENT_HTML5, 'UTF-8', false);
        }
