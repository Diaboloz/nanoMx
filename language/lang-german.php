...
define("_Z1", "Alle Logos und Warenzeichen auf dieser Seite sind Eigentum der jeweiligen Besitzer und Lizenzhalter.<br />Im übrigen gilt Haftungsausschluss. Weitere Details finden Sie im <a href=\"modules.php?name=Impressum\">Impressum</a>.");
define("_Z2", "Die Artikel sind geistiges Eigentum des/der jeweiligen Autoren,<br />alles andere &copy; by <a 
href=\"" . PMX_HOME_URL . "\">" . $GLOBALS['sitename'] . "</a>");
...
define("_YOUAREANON", "Sie sind ein anonymer Benutzer. Sie können sich <a href=\"modules.php?name=Your_Account\">hier anmelden.</a>");
define("_NOTE", "Notiz:");
...
define("_RESTRICTEDAREA", "Sie sind im Begriff einen geschützten Bereich zu betreten.");
define("_MODULEUSERS", "Es tut uns leid, aber dieser Bereich ist nur unseren <i>Registrierten Benutzern</i> zugänglich.<br /><br />Sie können sich kostenfrei registrieren, indem Sie <a href=\"modules.php?name=User_Registration\">hier</a> klicken,<br /> anschliessend haben Sie uneingeschränkten Zugriff auf diesen Bereich.<br /> Danke.");
...
define("_ADDAHOME", "Stellen Sie ein Modul als Startseite ein.");
define("_HOMEPROBLEMUSER", "Wir haben zur Zeit Probleme mit unserer Startseite. Bitte versuchen Sie es später nochmal.");
define("_DATE", "Datum");
define("_HOUR", "Stunde");
...
define("_BANNED", "Sie wurden vom AdminTeam gesperrt!<br /><br />Wenn Sie Genaueres wissen möchten, setzen Sie sich bitte, mit dem Team in Verbindung.");
define("_VKPBENCH1", "Seitenerstellung in ");
define("_VKPBENCH2", " Sekunden, mit ");
define("_VKPBENCH3", " Datenbank-Abfragen");
define("_ERRNOTOPIC", "Sie müssen ein Thema auswählen.");
define("_ERRNOTITLE", "Sie müssen einen Titel, für den Artikel, angeben.");
define("_ERRNOTEXT", "Sie müssen einen Text schreiben.");
...
define("_GROUPRESTRICTEDAREA", "Sorry, Sie haben keinen Zugriff auf diesen Teil der Website.");
...
define("_ERR_YOUBAD", "Sie haben versucht, eine ungültige Operation durchzuführen!");
...
define("_YOURELOGGEDIN", 'Danke, dass sie sich einloggen');
...
define('_USERNAMENOTALLOWED', 'Den Benutzernamen &quot;%s&quot; dürfen Sie nicht verwenden.'); // %s = sprintf()
...
define("_SETUPWARNING1", "Bitte benennen Sie den Setup-Ordner um, oder löschen Sie ihn!");
...
define("_REDIRECTMESS1", "Einen Moment, Sie werden in %d Sekunden weitergeleitet."); // %d = sprintf()
define("_REDIRECTMESS1A", "{Einen Moment, Sie werden in }s{ Sekunden weitergeleitet.}"); // {xx}s{xx} formated: http://eric.garside.name/docs.html?p=epiclock#ec-formatting-options
define("_REDIRECTMESS2", "Oder klicken Sie hier, wenn sie nicht warten möchten.");
...
define("_PAGEBREAK", "Wenn Sie mehrere Seiten möchten, kann mit <strong class=\"nowrap\">" . htmlspecialchars(PMX_PAGE_DELIMITER) . "</strong> ein Seitenumbruch eingefügt werden.");
...
define("_FILESECURERISK2", "Sie haben folgende Datei(en) nicht gelöscht:");
...
/* 2.4. */
//define ("_OFFLINE_0","Offline-Modus");
