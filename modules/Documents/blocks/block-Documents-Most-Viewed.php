...
$news = $cat->getRecords_MostViewed(5);
...
if ($newscount > 0) {
    ...
    foreach ($news as $cats) {
        ...
        if ($i < $preview) $width = 100;
        $content .= "<li class=\"mainpage\" style=\"display:inline-block;width: " . $width . "%;list-style-type:none;margin:0px;padding:5px;vertical-align:top;\"><div class=\"blogstory\">";
       ...
       // $content .= "<span class=\"blogstory-info\" style=\"float:right;\">" . _DOCS_CREATED . " " . _FROM . " : " . $cats['owner_name'] . " "
        ...
        if ($viewcontent) $content .= pmx_cutString($cats['text1'], $doc_cfg['cutlen'], false);
        $content .= "</p></div></li>";
        $i++;
    }
