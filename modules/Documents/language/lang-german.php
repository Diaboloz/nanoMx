...
define("_DOCS_PUBLISHED", "veröffentlichen");
...
define("_DOCS_EDIT_TEXT", "Hier können sie die Angaben zum Dokument bearbeiten");
...
define("_DOCS_MOVECONTENT", "Markierte Artikel werden in den gewählten Artikel verschoben. Sie können auch wieder einzelne Artikel abwählen. <br /> ACHTUNG: evtl. untergeordnete Artikel werden mit verschoben !!");

define("_DOCS_CHILDS", "enthaltene Artikel");
define("_DOCS_CONTENTDELETEINFO", "Markierte Artikel werden gelöscht inkl. ihrer eventuellen Anlagen !! Eventuelle Unterartikel werden in den übergeordneten Artikel verschoben");
...
define("_DOCS_SHORTDESC_TEXT", "Kurzbeschreibung des Dokumentes erscheint auf der Startseite des Dokumentes, nicht auf der Modul-Startseite.");
...
/* sociol */
define("_DOCS_SOCIAL_INFO_FACEBOOK", "2 Klicks für mehr Datenschutz: Erst wenn Sie hier klicken, wird der Button aktiv und Sie können Ihre Empfehlung an Facebook senden. Schon beim Aktivieren werden Daten an Dritte übertragen – siehe i.");
define("_DOCS_SOCIAL_INFO_TWITTER", "2 Klicks für mehr Datenschutz: Erst wenn Sie hier klicken, wird der Button aktiv und Sie können Ihre Empfehlung an Twitter senden. Schon beim Aktivieren werden Daten an Dritte übertragen – siehe i.");
define("_DOCS_SOCIAL_INFO_GPLUS", "2 Klicks für mehr Datenschutz: Erst wenn Sie hier klicken, wird der Button aktiv und Sie können Ihre Empfehlung an Google+ senden. Schon beim Aktivieren werden Daten an Dritte übertragen – siehe 'i'.");
define("_DOCS_SOCIAL_INFO_HELP", "Wenn Sie diese Felder durch einen Klick aktivieren, werden Informationen an Facebook, Twitter oder Google in die USA übertragen und unter Umständen auch dort gespeichert.");
define("_DOCS_SOCIAL_INFO_TOOLS", "Dauerhaft aktivieren und Datenübertragung zustimmen:");
...
define("_DOCS_PAGE_SIMILAR", "Diese Artikel könnten Sie auch interessieren:");
...
define("_DOCS_SELECT_ICON", "Hier köennen Sie ein Icon auswählen, welches im Titel angezeigt wird auf der Modulstartseite.");

define("_DOCS_ERR_FILESIZE", "Datei zu groß");
define("_DOCS_INFO_FILESIZE", "Maximale Dateigröße [kByte] :");

/* sendfriend */
define("_DOCS_RECYOURNAME", "Ihr Name:");
define("_DOCS_RECYOUREMAIL", "Ihre E-mail:");
